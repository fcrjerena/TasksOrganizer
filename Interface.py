...
def display_table(data):
    ...
    tree.column('Description', width=255, anchor='center')
    tree.column('Priority', width=200, anchor='center')
    tree.column('Complexity', width=50, anchor='center')
    tree.column('Deadline', width=150, anchor='center')
    tree.column('Main Task ID', width=50, anchor='center')
    tree.column('Blockers', width=200, anchor='center')
    tree.column('Created', width=50, anchor='center')
    tree.column('Delay', width=150, anchor='center')
    tree.column('Rank', width=50, anchor='center')
    tree.column('Status', width=200, anchor='center')
    tree.column('Comments', width=200, anchor='center')
